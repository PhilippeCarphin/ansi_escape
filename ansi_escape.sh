...
printf "CSI <n> G: Move cursor horizontally to column <n> (default=1)\n"
printf "CSI 6n   : Report cursor position (-> %s, \033[4m%s\033[0m)\n" "^[[<n>;<m>R" 'printf "\033[6n" ; read -s -d R pos; pos=${pos#*[}; row=${pos%;*}; col=${pos#*;}'
